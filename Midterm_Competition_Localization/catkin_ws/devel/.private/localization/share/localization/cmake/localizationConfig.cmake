...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /root/catkin_ws/src/localization)
  set(localization_DEVEL_PREFIX /root/catkin_ws/devel/.private/localization)
  ...
  set(localization_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'kaiyin <kaiyin0208.ee07@nycu.edu.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/localization/lib;/root/catkin_ws/devel/lib;/opt/ros/noetic/lib)
